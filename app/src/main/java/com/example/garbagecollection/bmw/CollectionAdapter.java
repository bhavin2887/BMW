...
public class CollectionAdapter extends BaseAdapter {
    ...
    public CollectionAdapter(Context context, List<WasteScanningAtHospitals> mArrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //holder.tv_coll_weight.setText("Bag Color : "+val[0]);
        if(mArrayList.get(position).getQRCodeContent().length()>=14){
